...
for symbol in SYMBOLS :
    ...
    url = "https://in.investing.com/indices/"+symbol+"-historical-data?end_date="+str(end_timestamp)+"&interval_sec=weekly&st_date="+str(start_timestamp)
